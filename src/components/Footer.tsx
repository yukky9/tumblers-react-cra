        ...
        <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
          ...
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              <a href={sourceLinks.vk} target="_blank" rel="noreferrer" className="rounded-full border border-white/12 px-4 py-2 text-sm font-semibold text-white/70 transition hover:border-white/30 hover:text-white">
                Вконтакте
              </a>
